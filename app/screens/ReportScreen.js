...
const HistoryEntry = () => {
  ...
  const food2 = historyData[1]
  const food3 = historyData[2]
    ...
    <TouchableOpacity onPress={toggleExpanded} style={styles.entryContainer}>
      <View style={styles.reportRow}>
        <View style={styles.reportCell}>
          <Text style={styles.reportValue}>{food1.FoodName}</Text>
        </View>
        <View style={styles.reportCell}>
          <Text style={styles.reportValue}>{food1.mass}</Text>
        </View>
        <View style={styles.reportCell}>
          <Text style={styles.reportValueTime}>{food1.id}</Text>
        </View>
      </View>
      {expanded && (
        <View style={styles.reportRow}>
          <View style={styles.nutritionalInfoContainer}>
            ...
            <View style={styles.tableRow}>
              ...
              <Text style={[styles.reportDetails, styles.column]}>{food1.Iron}</Text>
            </View>
